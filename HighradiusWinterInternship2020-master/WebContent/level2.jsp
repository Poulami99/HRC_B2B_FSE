...
<%@page import="com.highradius.internship.orderDao1" %>
...
List<order> list=orderDao1.getRecords(pageid,total);
int i=1;
for(order e:list){
%>
<tr class='rowclass'>
...
<br>
    <a href="level2.jsp?page=1"><button style="background-color:#EFF9FD;">1</button></a>  
	<a href="level2.jsp?page=2"><button style="background-color:#EFF9FD;">2</button></a>  
	<a href="level2.jsp?page=3"><button style="background-color:#EFF9FD;">3</button></a> 
	<a href="level2.jsp?page=4"><button style="background-color:#EFF9FD;">4</button></a>
	<a href="level2.jsp?page=5"><button style="background-color:#EFF9FD;">5</button></a> 
...
<script>
	  ...
	  if((row[rowNumber-1].getElementsByTagName('td')[7]).textContent == "Awaiting Approval")
		  ...
		  document.getElementById("aby1").value = "Laura Smith";
		  }
